...
estacion_actual = input("Ingrese la estacion del año (primavera-otoño-invierno-verano): ")
destino = input("A que destino viaja?: ")
...
match estacion_actual:
    ...
    case "verano":
        if destino == "mar del plata" or destino == "cataratas":
            ...
            print("No se viaja")
    case "otoño":
        print("Se viaja, no hay restricciones de destino")
    case "primavera":
        if destino == "bariloche":
            print("No se viaja")
        else:
