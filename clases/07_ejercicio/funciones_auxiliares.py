...
def obtener_recaudacion_cada_garage(lista_cantidad: list, lista_precios: list, lista_ganancias: list):
    
    for garage in range(len(lista_precios)):

        lista_cantidad[garage] * lista_precios[garage]
        lista_ganancias[indice] = ganancia
