...
from funciones_auxiliares import (
    ...
    obtener_datos_menor_cantidad_autos, mostrar_info_garages_maximos, obtener_recaudacion_cada_garage
)
...
def aplicacion(lista_marcas: list, lista_modelos: list, lista_precios: list, lista_cantidades: list, lista_ganancias: list):
    ...
    while corriendo:
        ...
        match opcion:
            ...
            case 5:
                obtener_recaudacion_cada_garage(lista_numero_garage, lista_marcas, lista_modelos, lista_cantidades, lista_precios, lista_ganancias)
            case 6:
                pass
            case 7:
                pass
