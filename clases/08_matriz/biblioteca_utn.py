...
def validar_existencia(input_usuario, palabra_1, palabra_2, palabra_3):
    while not input_usuario.isalpha() or (input_usuario != palabra_1 and input_usuario != palabra_2 and input_usuario != palabra_3):
        input_usuario = input(f"Ingrese un valor valido entre [{palabra_1}, {palabra_2}, {palabra_3}]: ").capitalize
